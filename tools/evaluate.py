...
def eval_parse_args():
    ...
    parser.add_argument('--perturb_region', default='none', type=str, help='perturb region')
...
def main_work():
    from ccm.cores.evaluater import Evaluator
    ...
    my_eval = Evaluator(custom_args, None)
    my_eval.eval_model()
