...
from cccv.cnn.layers import BaseConv as Conv2d
...
class MCNN(nn.Module):
    ...
    def __init__(self, load_weights=False, reduce_channel=1, bn=False):
        ...
        self.fuse = Conv2d(30, 1, 1, same_padding=True, bn=False, NL='None')
