...
class Crowd_Seg(nn.Module):
    def __init__(self, load_weights=False, reduce_channel=1):
        ...
        self.seg_pred = nn.Sequential(
            BaseConv(512 // reduce_channel, 256 // reduce_channel, kernel_size=3, same_padding=True, bn=True),
            BaseConv(256 // reduce_channel, 128 // reduce_channel, kernel_size=3, same_padding=True, bn=True),
            BaseConv(128 // reduce_channel, 1, kernel_size=1, NL='sigmoid', bn=False)
        )
